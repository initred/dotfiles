...
# Docker aliases
alias ld='cd ~/code/laradock'
alias dce=docker-compose-exec
alias dcew=docker-compose-exec-workspace
alias dcewa=docker-compose-exec-workspace-admin

function docker-compose-exec() {
    docker-compose exec "$@"
}

function docker-compose-exec-workspace() {
    docker-compose exec --user=laradock workspace zsh
}

function docker-compose-exec-workspace-admin() {
